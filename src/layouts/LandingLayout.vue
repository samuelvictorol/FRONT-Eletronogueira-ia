    ...
    <q-page-container>
      <q-page>
        ...
        <section class="hero">
          ...
          <div class="hero-content glass q-mx-sm">
            ...
            <p class="text-bold text-secondary">Ferramentas & Soluções</p>
            <p class="subtitle">
        ...
        <section id="horarios" class="section alt">
          <div class="container grid-2">
            <div class="glass card">
              <div class="text-h2">Horários</div>
              <table class="hours">
                <tbody>
                  <tr>
                    <td>Segunda-feira</td>
            ...
            <div id="como-chegar" class="glass card">
              <h2>Endereço</h2>
              <p><strong>Q D, LOTE, Av. Marginal, 01 - Esplanada I, Valparaíso de Goiás - GO, 72878-603</strong></p>
              <div class="cta-row">
                <q-btn color="blue" unelevated class="btn primary" type="a" target="_blank" rel="noopener"
                ...
                <q-btn flat class="btn ghost" href="tel:+556136290040" label="Ligar agora" />
              </div>
              <div class="mini-map">
        ...
        <footer class="footer">
          <div class="container footer-grid q-pb-md">
            <div>
              ...
              <p class="foot-copy q-pt-sm">Soluções em elétrica, hidráulica, automação e agro. Pronta-entrega e suporte
                técnico.
              </p>
            </div>
            <div class="foot-links">
              <a @click.prevent="scrollTo('#sobre')">Sobre</a>
              <a @click.prevent="scrollTo('#produtos')">Produtos</a>
              <a @click.prevent="scrollTo('#horarios')">Horários</a>
              <a @click.prevent="scrollTo('#como-chegar')">Como chegar</a>
            </div>
            <div class="column">
          ...
          <div class="copy">© {{ year }} Eletro Nogueira — 26.931.014/0001-12.</div>
        </footer>
